...
Provide `adj_p_cutoff` and `score_cutoff` in `metadata`:
```
metadata <- createMetadata(
  signature_name = "Myc_reduce_mice_liver_24m",
  organism = "Mus Musculus",
