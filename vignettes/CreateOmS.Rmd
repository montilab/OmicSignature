...
- **metadata**, a list. \
  ...
  Recommended optional fields: \
	"**phenotype**", "**platform**", "**sample_type**", \
...
### 2.3. Signature 
**signature** is a dataframe with column **"id"** and **"symbol"**, which should be subsets of "id" and "symbol" in the difexp, if present. If the signature is "bi-directional" or "multiple" (specified in `direction_type` in `metadata` list), then column **"direction"** is also required. \
