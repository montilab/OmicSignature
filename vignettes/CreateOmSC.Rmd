...
### 1. Import OmicSignature objects
Use `read.json()` function to read `OmicSignature` objects we want to put in the collection, or create them by hand. See [here](https://montilab.github.io/OmicSignature/articles/CreateOmS.html) for details to create them.  
