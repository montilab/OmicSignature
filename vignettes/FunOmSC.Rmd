...
For example, extract all features with a absolute score > 4.5 and p < 0.01 from all the `OmicSignature` object stored in this Collection. \
By default, the features are ranked by absolute score value. \
